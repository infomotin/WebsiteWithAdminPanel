<div class="lonyo-section-padding4 position-relative">
      ...
      <div class="row">
        <div class="col-lg-5 order-lg-2">
          <div class="lonyo-content-thumb" data-aos="fade-up" data-aos-duration="700">
            <img src="<?php echo e(asset('frontend/assets/images/v1/content-thumb2.png')); ?>" alt="">
          </div>
        </div>
        <div class="col-lg-7 d-flex align-items-center">
          <div class="lonyo-default-content pr-50" data-aos="fade-right" data-aos-duration="700">
            ...
            <div class="mt-50">
              <ul class="tabs">
                <li class="active-tab">
                  <img src="<?php echo e(asset('frontend/assets/images/v1/tv.svg')); ?>" alt="">
                  <h4>Unified Dashboard</h4>
                </li>
                <li>
                  <img src="<?php echo e(asset('frontend/assets/images/v1/alerm.svg')); ?>" alt="">
  ...
  </div><?php /**PATH D:\laragon\www\basic\resources\views\home\homelayout\get_all.blade.php ENDPATH**/ ?>