...
<ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
    ...
    <li class="dropdown notification-list topbar-dropdown">
        <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
            <img src="<?php echo e((!empty($profileData->photo)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?>" alt="user-image" class="rounded-circle">
            <span class="pro-user-name ms-1">
                <?php echo e($profileData->name); ?> <i class="mdi mdi-chevron-down"></i> 
            </span>
        </a>
...
</div><?php /**PATH D:\laragon\www\basic\resources\views\admin\body\header.blade.php ENDPATH**/ ?>