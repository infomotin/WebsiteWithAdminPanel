<div class="carousel-header">
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('frontend1/img/carousel-1.jpg')); ?>" class="img-fluid" alt="Image">
                    ...
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('frontend1/img/carousel-2.jpg')); ?>" class="img-fluid" alt="Image">
                        <div class="carousel-caption">
                            <div class="text-center p-4" style="max-width: 900px;">
        ...
        </div><?php /**PATH D:\laragon\www\basic\resources\views\frontend\home\components\carousel.blade.php ENDPATH**/ ?>