<div class="container-fluid service overflow-hidden pt-5">
                ...
                <div class="row g-4">
                        ...
                        <div class="service-item">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="<?php echo e(asset('frontend1/img/service-1.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="<?php echo e(asset('frontend1/img/service-2.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                </div>
                                <div class="service-title">
                                    <div class="service-title-name">
                                        <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                    ...
                    <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item">
                            <div class="service-inner">
                                <div class="service-img">
                                    <img src="<?php echo e(asset('frontend1/img/service-3.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                </div>
                                <div class="service-title">
                                    <div class="service-title-name">
                                        <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
        ...
        </div><?php /**PATH D:\laragon\www\basic\resources\views\frontend\home\components\services.blade.php ENDPATH**/ ?>