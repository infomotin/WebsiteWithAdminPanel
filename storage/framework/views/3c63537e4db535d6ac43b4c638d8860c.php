...
<div class="account-page">
                        ...
                        <div class="mb-0 border-0 p-md-5 p-lg-0 p-4">
                            <div class="mb-4 p-0">
                                <a href="index.html" class="auth-logo">
                                    <img src="<?php echo e(asset('backend/assets/images/logo-dark.png')); ?>" alt="logo-dark" class="mx-auto" height="28" />
                                </a>
                            </div>
    ...
    <form  method="POST" action="<?php echo e(route('custom.verification.verify')); ?>" class="my-4">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Don't have an account ?<a class='text-primary ms-2 fw-medium' href='<?php echo e(route('register')); ?>'>Sing up</a></p>
    </div>
                ...
                <div class="account-page-bg p-md-5 p-4">
                    <div class="text-center">
                        ...
                        <div class="auth-image">
                            <img src="<?php echo e(asset('backend/assets/images/authentication.svg')); ?>" class="mx-auto img-fluid"  alt="images">
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH D:\laragon\www\basic\resources\views\auth\verify.blade.php ENDPATH**/ ?>