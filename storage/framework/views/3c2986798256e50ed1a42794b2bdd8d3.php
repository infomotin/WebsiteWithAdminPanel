<div class="container-fluid py-5">
                ...
                <div class="row g-5">
                    <div class="col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="bg-light rounded">
                            <img src="<?php echo e(asset('frontend1/img/about-2.png')); ?>" class="img-fluid w-100" style="margin-bottom: -7px;" alt="Image">
                            <img src="<?php echo e(asset('frontend1/img/about-3.jpg')); ?>" class="img-fluid w-100 border-bottom border-5 border-primary" style="border-top-right-radius: 300px; border-top-left-radius: 300px;" alt="Image">
                        </div>
                    </div>
        ...
        </div><?php /**PATH D:\laragon\www\basic\resources\views\frontend\home\components\about.blade.php ENDPATH**/ ?>