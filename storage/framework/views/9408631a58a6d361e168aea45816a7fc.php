...
<div class="card-body">
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-lg-12 col-xl-12">
            <img id="showImage" src="<?php echo e(asset($about->image)); ?>" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">   
...
<?php echo $__env->make('admin.admin_master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\basic\resources\views\admin\backend\about\get_about.blade.php ENDPATH**/ ?>