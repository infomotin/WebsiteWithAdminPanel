<div class="container-fluid training overflow-hidden bg-light py-5">
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="training-item">
                            <div class="training-inner">
                                <img src="<?php echo e(asset('frontend1/img/training-1.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                    ...
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="training-item">
                            <div class="training-inner">
                                <img src="<?php echo e(asset('frontend1/img/training-2.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                <div class="training-title-name">
                    ...
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="training-item">
                            <div class="training-inner">
                                <img src="<?php echo e(asset('frontend1/img/training-3.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                <div class="training-title-name">
                    ...
                    <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="training-item">
                            <div class="training-inner">
                                <img src="<?php echo e(asset('frontend1/img/training-4.jpg')); ?>" class="img-fluid w-100 rounded" alt="Image">
                                <div class="training-title-name">
        ...
        </div><?php /**PATH D:\laragon\www\basic\resources\views\frontend\home\components\training.blade.php ENDPATH**/ ?>