...
<head>
    ...
    <!-- Quill css -->
    <link href="<?php echo e(asset('backend/assets/libs/quill/quill.core.js')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/quill/quill.snow.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/quill/quill.bubble.css')); ?>" rel="stylesheet" type="text/css" />

    <!-- Datatables css -->
    <link href="<?php echo e(asset('backend/assets/libs/datatables.net-bs5/css/dataTables.bootstrap5.min.css')); ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css')); ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/datatables.net-keytable-bs5/css/keyTable.bootstrap5.min.css')); ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css')); ?>"
        rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('backend/assets/libs/datatables.net-select-bs5/css/select.bootstrap5.min.css')); ?>"
        rel="stylesheet" type="text/css" />
...
<body data-menu-color="light" data-sidebar="default">
    ...
    <script src="<?php echo e(asset('backend/assets/libs/waypoints/lib/jquery.waypoints.min.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/assets/libs/jquery.counterup/jquery.counterup.min.js')); ?>"></script>
    ...
    <!-- Widgets Init Js -->
    <script src="<?php echo e(asset('backend/assets/js/pages/analytics-dashboard.init.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('backend/assets/js/pages/datatable.init.js')); ?>"></script>

    <!-- Quill Editor Js -->
    <script src="<?php echo e(asset('backend/assets/libs/quill/quill.core.js')); ?>"></script>
    <script src="<?php echo e(asset('backend/assets/libs/quill/quill.min.js')); ?>"></script>

    <!-- Quill Demo Js -->
    <script src="<?php echo e(asset('backend/assets/js/pages/quilljs.init.js')); ?>"></script>
