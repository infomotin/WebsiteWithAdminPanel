...
<div class="account-page">
    ...
    <div class="text-center text-muted mb-4">
        <p class="mb-0">Want to login ?<a class='text-primary ms-2 fw-medium' href='<?php echo e(route('login')); ?>'>Sing In</a></p>
    </div>
...
</html><?php /**PATH D:\laragon\www\basic\resources\views\auth\register.blade.php ENDPATH**/ ?>